...
// Standardizing on the .firebasestorage.app bucket name for consistency with the Admin SDK.
const firebaseConfig = {
  apiKey: "AIzaSyAanUGeE4WzPNUCfx9d_KSM4vt5cZdStJg",
  authDomain: "civiclens-bexm4.firebaseapp.com",
  projectId: "civiclens-bexm4",
  storageBucket: "civiclens-bexm4.firebasestorage.app", // Use the .firebasestorage.app format for consistency
